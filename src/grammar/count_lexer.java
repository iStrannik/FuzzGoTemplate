...
public class count_lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"Text", "Template", "Block", "With", "CommentBegin", "CommentEnd", "If", 
			"Else", "Range", "Pipe", "Comma", "Assignment", "Equal", "Nil", "LeftParenthesis", 
			"RightParenthesis", "Dollar", "Dot", "End", "BlockStart", "Dash", "BlockEnd", 
			"Constant", "Define", "And", "Eq", "Lt", "Le", "Ne", "Gt", "Ge", "Len", 
			"Not", "Or", "Index", "Slice", "Printf", "Myprint", "Random", "AnyText", 
			"AStart", "HrefStart", "HrefEnd", "ScriptStart", "ScriptEnd", "StyleStart", 
			"StyleEnd", "BrStart", "BrEnd", "ImgStart", "AEnd", "ImgEnd", "StringConstant", 
	...
	public count_lexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "count_lexer.g4"; }
	...
	public void action(RuleContext _localctx, int ruleIndex, int actionIndex) {
		switch (ruleIndex) {
		case 53:
			NumberConstant_action((RuleContext)_localctx, actionIndex);
			break;
		case 54:
	...
	private void NumberConstant_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
			1
			break;
